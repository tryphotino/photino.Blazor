...
internal sealed class Host : IHost, IAsyncDisposable
{
                ...
                IOptions<HostOptions> options)
    {
        ...
        {
            throw new ArgumentException("IHostApplicationLifetimeReplacementNotSupported", nameof(applicationLifetime));
        }
        _logger = logger;
...
#pragma warning restore CA1068 // I parametri CancellationToken devono essere indicati per ultimi
    ...
    internal sealed class HostDebugView(Host host)
    {
        ...
        public List<IHostedService> HostedServices => new(host._hostedServices ??= host.Services.GetRequiredService<IEnumerable<IHostedService>>());
